...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1001763959518 -1001900210731').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/howtosolvelinks/2')  # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howtosolvelinks/2')  # Tutorial video link for opening shortlink website
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/benzmawabot')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/benzmovies')
